...
| :--- | :--- | :--- |
| **[skill-manager](./skills/skill-manager/SKILL.md)** | Personal | 专门用于自动化管理和注册本项目技能的元工具。支持个人技能登记与外部引用关联。 |
| **[git-commit](./skills/git-commit/SKILL.md)** | Personal | 综合性 Git 智能体技能，强制要求中文提交信息。结合战略工作流、严格的 Conventional Commits 标准和安全执行协议。以资深工程师的视角引导原子化、可验证且标准化的 Git 操作。 |
