...
| :-------------------------------------------------------------------- | :-------------- | :--------------------------------------------------------------------------------------------------------------------------------- |
| **[git-commit-expert](./git-commit-expert/SKILL.md)**                 | ⭐ **Featured** | A comprehensive Git agent skill combining strategic workflows, strict conventional commit standards, and safe execution protocols. |
| **[baseline-ui](./baseline-ui/SKILL.md)**                             | Curated         | Enforces an opinionated UI baseline to prevent AI-generated interface slop.                                                        |
| **[fixing-accessibility](./fixing-accessibility/SKILL.md)**           | Curated         | Fix accessibility issues. Ensure the component is accessible to all users.                                                         |
| **[fixing-motion-performance](./fixing-motion-performance/SKILL.md)** | Curated         | Fix animation performance issues. Optimize animations and interactions.                                                            |
| **[web-design-guidelines](./web-design-guidelines/SKILL.md)**         | Curated         | Review UI code for Web Interface Guidelines compliance.                                                                            |
| **[fixing-metadata](./fixing-metadata/SKILL.md)**                     | Curated         | Ship correct, complete metadata for SEO and performance optimization.                                                              |
